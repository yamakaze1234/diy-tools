...
import {clone,erpUnitCost} from './core.js';
...
export function openSourceEditor(liveApi){
 ...
 async function saveAll(){
  ...
  message(`正在保存 ${pending.size} 条输出源及加购修改，请稍候…`);
  try{
